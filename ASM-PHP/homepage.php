...
<body class="bg-gray-300">
  <div class="container mx-auto p-8 ">
    ...
    <a class="bg-green-400 text-white p-2 rounded-md" href = "Addpage.php">Add <span class="ml-2">+</span></a>
    <div class="">
          ...
          if ($result) {
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    <td>" . $row["class"]."</td>
                    <td>
                    <a class=\"bg-red-400 text-white p-2 rounded-md\" href=\"Deletepage.php?id=" . $row["id"] . "\"> <span class=\"ml-2\">-</span></a>
                    <a class=\"bg-blue-400 text-white p-2 rounded-md\" href=\"Editpage.php?id=" . $row["id"] . "\"> <span class=\"ml-2\">✎</span></a>
                    </td>
                    </tr>";
                }
            } else {
